      ...
      VawinvTheme.FaioColor.backgroundBlack.ignoresSafeArea()
        ...
        VStack {
          ...
          HStack {
            ...
            .onSubmit {
                chatVM.addMessage(sendMsg: NwuzawiGhrdcjsMessage(nuwzawiGhrdcjsRoomId: owianRoomId, nwuzawiGhrdcjsSendUserId: userVM.currentUser!.feruyqCawdUserId, nwuzawiGhrdcjsTextMsg: owianInputText, nwuzawiGhrdcjsDate: Date()))
                owianInputText = ""
            }
  ...
  var body: some View {
    ...
    struct FaioMessageRow: View {
        ...
        private var bubbleBackground: some View {
            ...
            .fill(isMe ? VawinvTheme.FaioColor.gradientOrangeToYellow : LinearGradient(
                colors: [.white],
                startPoint: .top,
                endPoint: .bottom
              ))
