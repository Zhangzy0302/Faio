...
struct BnainzcScriptWriting: View {
  ...
  private let bnainzMovieTheme = [
    "Adventure", "Romance", "Sci-fi", "Suspense", "History", "Fantasy",
  ]
      ...
      VStack {
        ...
        ScrollView {
          VStack(alignment: .leading, spacing: 24) {
            BanziwSelectTags(
              banziwTitle: "Movie Theme", banziwTagsList: bnainzMovieTheme,
              seletedTag: $bnainzSeletedTheme)
            BanziwSelectTags(
              banziwTitle: "Movie style", banziwTagsList: bnainzMovieStyle,
              seletedTag: $bnainzSeletedStyle)
            BanziwSelectTags(
              banziwTitle: "Character", banziwTagsList: bnainzCharacter,
              seletedTag: $bnainzSeletedCharacter)
            VStack(alignment: .leading, spacing: 12) {
              ...
              BawnbvTextField(
                placeholder: "Please enter some keywords of your ideas for the movie script...",
