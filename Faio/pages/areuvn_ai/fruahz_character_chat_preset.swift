      ...
      VStack {
        ...
        ScrollView {
          VStack(alignment: .leading, spacing: 24) {
            BanziwSelectTags(
              banziwTitle: "Character", banziwTagsList: fruahzCharacters,
              seletedTag: $fruzhSeletedCharacter)
            BanziwSelectTags(
              banziwTitle: "Chat direction", banziwTagsList: fruzhzChatDirection,
              seletedTag: $fruzhSeletedDirection)
            ...
            VStack(alignment: .leading, spacing: 12) {
              ...
              BawnbvTextField(
                placeholder: "Which movie would you like this character to appear in?",
                text: $fruzhInputMoive, isFocused: $fruzhInputIsFocus_1, height: 128)
            }
            VStack(alignment: .leading, spacing: 12) {
              Text("Character Name")
                .font(.system(size: 18))
                ...
                .foregroundColor(.white)
              BawnbvTextField(
                placeholder: "please enter", text: $fruzhInputCharacterName,
                isFocused: $fruzhInputIsFocus_2)
            }
            ...
            Button(action: {
              ...
              if userVM.currentUser?.feruyqCawdWalletBalance ?? 0 > 600 {
                ...
                appPath.append(
                  AppRoute.aiChatRoom(
                    character: fruzhSeletedCharacter, chatDirection: fruzhSeletedDirection,
                    characterName: fruzhInputCharacterName))
              } else {
