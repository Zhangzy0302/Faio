...
struct TuryhajFollowButton: View {
    ...
    var body: some View {
        ...
        FeqocnButton(
            feqocnText: cnzadjIsFollowed ? "Unfollow" : "Follow", feqocnWidth: turyWidth, feqocnHeight: turyHeight, feqocnBgColorIsOrange: !cnzadjIsFollowed,
            feqocnBgColor: Color(red: 85/255, green: 85/255, blue: 85/255),
            feqocnFontSize: turyFontSize, feqocnFontWeight: .semibold, feqocnFontColor: !cnzadjIsFollowed ? turyTextColor : .white,
            action: {
